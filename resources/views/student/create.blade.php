        ...
        <div class="col-md-8 mt-5">
            <form action="{{ route('student.store') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="address" id="address" class="form-control" placeholder="Enter Student's Address">
                </div>

                <div class="form-group">
                    <label for="">Age</label>
                    <input type="number" name="age" id="age" class="form-control" placeholder="Enter Student's Age">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="contact" id="contact" class="form-control" placeholder="Enter Student's Contact ">
                </div>
